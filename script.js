...
toggleThemeButton.addEventListener("click", () => {
  const currentTheme =
    themeStyle.getAttribute("href") === "darkMode.css" ? "light" : "dark";
...
const professions = ["Front End Developer", "Computer Engineer"];
...
function erase() {
  if (charIndex > 0) {
    typingText.textContent = professions[professionIndex].substring(
      0,
      charIndex - 1
    );
    charIndex--;
